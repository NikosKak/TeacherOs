...
namespace TeacherOs.Data;

public partial class SchoolOsContext : DbContext
{
    public SchoolOsContext()
    {
    }

    public SchoolOsContext(DbContextOptions<SchoolOsContext> options)
        : base(options)
    {
    }
